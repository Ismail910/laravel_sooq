...
@if(auth()->check())
    tinymce.init({
        ...
        images_upload_url:"{{route('front.upload.image',['_token' => csrf_token() ])}}",
    ...
    notificationDropdowns.forEach(function(notificationDropdown) {
        notificationDropdown.addEventListener('show.bs.dropdown', function() {
            $.ajax({
                method: "POST",
                url: "{{route('front.notifications.see')}}",
    ...
    function get_notifications() {
        $.ajax({
            method: "GET",
            url: "{{route('front.notifications.ajax')}}",
