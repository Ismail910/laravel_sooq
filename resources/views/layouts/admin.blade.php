...
<body style="background: #f7f7f7" class="dash">
    ...
    @php
        ...
        $representatives_count = \App\Models\Representative::count();
        ...
        <div style="width: 250px;background: #11233b;min-height: 100vh;position: fixed;z-index: 100"
            ...
            <div class="col-12 px-0">
                <div class="col-12 px-0 aside-menu" style="height: calc(100vh - 150px);overflow: auto;">
                    ...
                    @can('viewAny', \App\Models\Slider::class)
                        <a href="{{ route('admin.sliders.index') }}" class="col-12 px-0">
                            <div class="col-12 item px-0 d-flex">
                                ...
                                <div style="width: calc(100% - 50px)" class="px-2">ادارة السلايدر
                                    @if ($sliders_count)
                                        <span
                    ...
                    @endcan
                    @can('viewAny', \App\Models\HelpCenter::class)
                        <a href="{{ route('admin.help-center.index') }}" class="col-12 px-0">
                            <div class="col-12 item px-0 d-flex ">
                                <div style="width: 50px" class="px-3 text-center">
                                    <span class="far fa-question-circle font-2"> </span>
                                </div>
                                <div style="width: calc(100% - 50px)" class="px-2">
                                    إدارة مركز المساعدة
                                </div>
                    ...
                    @can('viewAny', \App\Models\Voucher::class)
                        <a href="{{ route('admin.voucher.index') }}" class="col-12 px-0">
                            <div class="col-12 item px-0 d-flex">
                                <div style="width: 50px" class="px-3 text-center">
                                    <span class="fal fa-flag font-2"> </span>
                                </div>
                                <div style="width: calc(100% - 50px)" class="px-2">
                                    إدارة قسائم الشراء
                                    @if (\App\Models\Voucher::count() >= 1)
                                        <span
                                            style="background: #1eaa22;border-radius: 2px;color:#fff;display: inline-block;font-size: 11px;text-align: center;padding: 1px 5px;">{{ \App\Models\Voucher::count() }}</span>
                                    @endif
                                </div>
                            </div>
                        </a>
                    ...
                    @if (auth()->user()->hasPermissionTo('show countries') ||
                            auth()->user()->hasPermissionTo('show currencies'))
                    ...
                    @if (auth()->user()->hasPermissionTo('show users') ||
                            auth()->user()->hasPermissionTo('show representatives') ||
                            auth()->user()->hasPermissionTo('show stores') ||
                            auth()->user()->hasPermissionTo('show categories') ||
                            auth()->user()->hasPermissionTo('show packages') ||
                            auth()->user()->hasPermissionTo('show announcements') ||
                            auth()->user()->hasPermissionTo('show subscriptions'))
                    ...
                    @endcan
                    @can('viewAny', \App\Models\Representative::class)
                        <a href="{{ route('admin.representatives.index') }}" class="col-12 px-0">
                            <div class="col-12 item px-0 d-flex ">
                                <div style="width: 50px" class="px-3 text-center">
                                    <span class="fal fa-users font-2"> </span>
                                </div>
                                <div style="width: calc(100% - 50px)" class="px-2">
                                    إدارة المناديب
                                    @if ($representatives_count)
                                        <span
                                            style="background: #6cd339;border-radius: 2px;color:#fff;display: inline-block;font-size: 11px;text-align: center;padding: 1px 5px;">{{ $representatives_count }}</span>
                                    @endif
                                </div>
                            </div>
                        </a>
                    ...
                    @if (auth()->user()->hasPermissionTo('show transactions'))
                        <span class="text-muted px-3">إدارة المحافظ</span>
                    @endif

                    <hr>

                    @can('create', \App\Models\Transaction::class)
                        <a href="{{ route('admin.transactions.create') }}" class="col-12 px-0">
                            <div class="col-12 item px-0 d-flex ">
                                <div style="width: 50px" class="px-3 text-center">
                                    <span class="fal fa-dollar-sign font-2"> </span>
                                </div>
                    ...
                    @can('viewAny', \App\Models\Transaction::class)
                        <a href="{{ route('admin.transactions.index') }}" class="col-12 px-0">
                            <div class="col-12 item px-0 d-flex ">
                                <div style="width: 50px" class="px-3 text-center">
                                    <span class="fal fa-wallet font-2"> </span>
                                </div>
                                <div style="width: calc(100% - 50px)" class="px-2">
                                    كل المحافظ
                                    @if ($transactions_count)
                                        <span
                                            style="background: #6cd339;border-radius: 2px;color:#fff;display: inline-block;font-size: 11px;text-align: center;padding: 1px 5px;">{{ $transactions_count }}</span>
                                    @endif
                                </div>
                            </div>
                        </a>
                    ...
                    @can('viewAny', \App\Models\Role::class)
                        <a href="{{ route('admin.roles.index') }}" class="col-12 px-0">
                            <div class="col-12 item px-0 d-flex ">
                                <div style="width: 50px" class="px-3 text-center">
                                    <span class="fal fa-unlock font-2"> </span>
                                </div>
                                <div style="width: calc(100% - 50px)" class="px-2">
                                    الصلاحيات
                                </div>
        ...
        <div class="main-content in-active" style="overflow: hidden;">
            <div class="col-12 px-0 d-flex justify-content-between top-nav"
                ...
                <div class="col-12 px-0 d-flex justify-content-end  " style="height: 60px;">
                    <div class="btn-group notificationDropdown" id="notificationDropdown">
