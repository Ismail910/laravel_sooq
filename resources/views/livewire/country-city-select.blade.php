    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-6 mb-3 mb-lg-0">
            <div class="custom-select2">
                ...
                <select wire:change="City()" class="form-control" name="country" wire:model="country_id" style="border-radius: 20px;padding: 10px 40px;color: #821b;">
        ...
        <div class="col-12 col-lg-6 mb-3 mb-lg-0">
            <div class="custom-select2">
                {{-- <span class='spanIcon fas fas fa-map-marker-alt font-2'></span> --}}
                <select name="city" class="form-control" wire:model="city_id" style="border-radius: 20px;padding: 10px 40px;color: #821b;">
