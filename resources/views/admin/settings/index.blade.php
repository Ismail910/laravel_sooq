            ...
            <form class="col-12 row " id="validate-form" method="POST"
                ...
                <div class="col-12 col-lg-8 px-3 py-5">
                    ...
                    <div class="col-12 row p-0 taber active" id="general-tab">
                        ...
                        <div class="col-12 px-0 d-flex mb-3 row pb-3">
                            <div class="col-12 col-lg-3 px-2 text-lg-end pt-1 pb-3 pb-lg-0">
                                العلامة المائية(png فقط)
                            </div>
                            <div class="col-12 col-lg-9 px-2">
                                <input type="file" name="website_watermark" class="form-control" accept="image/png">
                                <div class="col-12 p-2">
                                    <img src="{{ $settings->website_watermark() }}" style="width:100px;max-height: 100px;">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 row p-0 taber" id="links-tab">
                        <div class="col-12 px-0 d-flex mb-3 row pb-3">
                            ...
                            <div class="col-12 col-lg-9 px-2">
                                <input type="" name="phone" class="form-control"
                                    value="{{ $settings->phone }}" maxlength="190">
                            </div>
                        </div>
                        <div class="col-12 px-0 d-flex mb-3 row pb-3">
                            <div class="col-12 col-lg-3 px-2 text-lg-end pt-1 pb-3 pb-lg-0">
                            ...
                            <div class="col-12 col-lg-9 px-2">
                                <input type="" name="phone2" class="form-control"
                                    value="{{ $settings->phone2 }}" maxlength="190">
                            </div>
                        </div>
                        <div class="col-12 px-0 d-flex mb-3 row pb-3">
                            <div class="col-12 col-lg-3 px-2 text-lg-end pt-1 pb-3 pb-lg-0">
                        ...
                        <div class="col-12 px-0 d-flex mb-3 row pb-3">
                            ...
                            <div class="col-12 col-lg-9 px-2">
                                <input type="url" name="another_link1" class="form-control"
                                    value="{{ $settings->another_link1 }}">
                            </div>
                        </div>
                        <div class="col-12 px-0 d-flex mb-3 row pb-3">
                            <div class="col-12 col-lg-3 px-2 text-lg-end pt-1 pb-3 pb-lg-0">
                            ...
                            <div class="col-12 col-lg-9 px-2">
                                <input type="url" name="another_link2" class="form-control"
                                    value="{{ $settings->another_link2 }}">
                            </div>
                        </div>
                        <div class="col-12 px-0 d-flex mb-3 row pb-3">
                            <div class="col-12 col-lg-3 px-2 text-lg-end pt-1 pb-3 pb-lg-0">
                                ...
                                <div class="tab-pane fade show {{ $loop->first ? 'active' : '' }}"
                                    ...
                                    <div class="col-12 col-lg-12 my-2">
                                        ...
                                        <div class="col-12 pt-3">
                                            <textarea class="form-control editor with-file-explorer" name="{{ $key }}[about_page]" style="min-height: 200px">{{ $settings->getTranslation('about_page', $key) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-12 my-2">
                                        ...
                                        <div class="col-12 pt-3">
                                            <textarea class="form-control editor with-file-explorer" name="{{ $key }}[privacy_page]" style="min-height: 200px">{{ $settings->getTranslation('privacy_page', $key) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
