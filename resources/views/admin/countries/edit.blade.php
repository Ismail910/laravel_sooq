			...
			<div class="col-12 p-3 row">
                ...
                <div class="col-12 p-2">
                    ...
                    <div class="col-12 pt-3 position-relative">
                        <input type="text"  name="code" required class="form-control ms-1" value="{{$country->code}}">
                    </div>
                    <div class="col-12 pt-3">
                ...
                <div class="col-12 p-2">
                    ...
                    <div class="col-12 pt-3 position-relative">
                        ...
                        <input type="number"  name="phone_code" required class="form-control ms-1" value="{{$country->phone_code}}">
                    </div>
                    <div class="col-12 pt-3">
