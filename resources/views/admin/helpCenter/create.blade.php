...
<div class="col-12 p-3">
	<div class="col-12 col-lg-12 p-0 ">
		...
		<form id="validate-form" class="row" enctype="multipart/form-data" method="POST" action="{{route('admin.help-center.store')}}">
		@csrf
                ...
                <div class="col-12 col-lg-6 p-2">
                        ...
                        <div class="tab-pane fade show {{ $loop->first ? 'active' : '' }}" id="pills-{{ $key }}" role="tabpanel" aria-labelledby="pills-{{ $key }}-tab">
                            <div class="col-12 col-lg-12 p-2">
                                ...
                                <div class="col-12 pt-3">
                                    <input type="text" name="{{ $key }}[title]" required class="form-control">
                                </div>
                            </div>
                    ...
                    <div class="col-12  p-2">
                        <div class="col-6">
                            ...
                            <div class="pt-3">
                                <input type="text" class="form-control" name="link" requiredclass="form-control" value="{{ old('link') }}">
                            </div>
                        </div>
                        <div class="col-6">
                            <div>
