        ...
        <div class="col-12 col-lg-12 p-0 ">
            ...
            <form id="validate-form" class="row" enctype="multipart/form-data" method="POST"
                ...
                <div class="col-12 col-lg-8 p-0 main-box">
                    ...
                    <div class="col-12 p-3">
                        <livewire:city :country_id="$user->city->country_id ?? null" :city_id="$user->city->id ?? null" />
                        ...
                        <div class="col-12 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <select class="form-control" name="power">
                                    ...
                                    <option @selected($user->power == 'ADMIN') value="ADMIN">مسؤول</option>
                                    <option @selected($user->power == 'USER') value="USER">مستخدم</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-12 pt-3">
                                <select class="form-control" name="role">
                                    ...
                                    @foreach ($roles as $role)
                                        <option value="{{$role->name}}" @checked($user->role == $role->name)>{{$role->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
