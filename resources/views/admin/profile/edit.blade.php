...
@section('styles')
    <style type="text/css">
        ...
        .cr-image {
            opacity: 1;
            transform: translate3d(-26.8762px, -9.88808px, 0px) scale(1.0007);
            transform-origin: 176.876px 159.888px;
        }
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-12 p-2"
                        style="background: #fff;overflow: hidden;position: relative;max-width: 100%!important">
                            ...
                            <div class="col-12 p-3">
                                ...
                                <div class="col-12 p-2">
                                    ...
                                    <div class="col-12 pt-3">
                                        <input type="file" name="" class="form-control image-upload" value="{{ auth()->user()->name }}" id="avatar-image">
