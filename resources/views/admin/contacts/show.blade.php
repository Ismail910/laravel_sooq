                                ...
                                @if ($contact->user_id != null)
                                    <a href="{{ route('admin.users.index', ['id' => $contact->user_id]) }}"
                                        ...
                                        <span style="display: inline-block;position: relative;top: 6px; "
                                            class="px-2 pt-0  float-end kufi"> </span>
                                    </a>
                                @else
                                ...
                                <div class="col-12 px-0 row">
                                    <div class="col-7 px-0">
                                        ...
                                        @if ($contact->user_id != null)
                                            ...
                                            @else
                                                <span style="font-size:13px;opacity: .7;font-weight: bold;color: var(--bg-color-0)" class="kufi">
                                    ...
                                    <div class="col-5 px-0 text-end">
                                        <span style="font-size:14px;opacity: .7"
                                            class="naskh">{{ \Carbon::parse($contact->created_at)->diffForHumans() }}</span>
                                    </div>
                                </div>
                                <div class="col-12 px-0">
                                    <div style=" position: relative;top: 0px;" class="py-2">
                                        <span
                                            ...
                                            class="p-0 naskh"> {{ $contact->message }}</span>
                                    </div>
            ...
            <div class="col-12 p-0">
                ...
                @foreach ($contact->replies as $reply)
                    <div class="col-12 px-1 px-lg-3 row py-2 message" style="direction: rtl;" id="{{ $reply->id }}">
                        <div class="col-12 col-md-10 col-lg-9 col-xl-6 p-2 row rounded-2"
                            style="direction: rtl;background:#d7eeff;">
                            <div style="width:70px;" class="text-center d-none d-md-flex align-items-start">
                                <div class="d-inline-block">
                                    <a href="{{ route('admin.users.index', ['id' => $reply->user_id]) }}"
                                        class="d-inline-block text-center">
                                        <img src="{{ $reply->user->getUserAvatar() }}"
                                            style="width: 45px;height: 45px;display: inline-block;border-radius: 50%!important;padding: 3px;"
                                            class="mx-auto" alt="صورة المستخدم">
                                        <span style="display: inline-block;position: relative;top: 6px; "
                                            class="px-2 pt-0  float-end kufi"> </span>
                                        ...
                                        <div class="col-7 px-0">
                                            <a href="{{ route('admin.users.index', ['id' => $reply->user_id]) }}"
                                                ...
                                                <span
                                                    ...
                                                    class="kufi">{{ $reply->user->name }}</span></a>

                                        </div>
                                        <div class="col-5 px-0 text-end">
                                            <span style="font-size:14px;opacity: .7"
                                                class="naskh">{{ \Carbon::parse($reply->created_at)->diffForHumans() }}</span>
                                        </div>
                                    </div>
                                    <div class="col-12 px-0">
                                        <div style=" position: relative;top: 0px;" class="py-2">
                                            <span
                                                style=" position: relative;color: var(--bg-color-0); font-size: 17px;white-space: pre-line;word-wrap: break-word;overflow: hidden;  "
                                                class="p-0 naskh"> {{ $reply->content }}</span>
                                        </div>
                                        <div class="col-12 px-1">
                                            <div class="col-12 px-0">
                                            </div>
