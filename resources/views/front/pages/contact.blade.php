            ...
            <div class="col-12 col-lg-6 p-0 mx-auto">
                <div style="max-width: 100%;text-align: justify;" class="mx-auto p-0 font-2 naskh">
                    <form class="" method="POST" action="{{route('contact-post')}}" id="contact-form">
                        ...
                        <div class="col-12 px-0 py-3">
                            <div class="col-12">
                                <input type="email" name="email" class="form-control rounded-0" placeholder="{{ __('lang.Email Address') }}" required="" value="">
                            </div>
                        </div>
                        <div class="col-12 px-0 py-3">
                            <div class="col-12">
                        ...
                        <div class="col-12 px-0 py-3">
                            <div class="col-12">
                                <select class="form-control" name="type" required="">
                                    ...
                                    <option value="inquiry">{{ __('lang.Inquiry') }}</option>
                                    <option value="representative_visit">{{ __('lang.Representative visit') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-12 px-0 py-3">
