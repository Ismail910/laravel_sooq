                ...
                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-8">
                            <div class="form-group row pb-3">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input id="phone" type="number" placeholder="962780997333" class="text-start form-control rounded-3 @error('phone') is-invalid @enderror" name="phone" value="@if(isset($phone) && $phone){{ $phone }}@else{{ old('phone') }}@endif" required autocomplete="phone" autofocus>
                                    @error('phone')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-12 col-lg-4 text-center">
                            ...
                            <small>{{ __("lang.Upload Image") }}</small>
                        </div>
        ...
        $(() => {
            fetch("https://ipapi.co/json/")
                ...
                .then(data => {
                    ...
                    const countryId = $('#country').find(`option[data-code=${countryCode}]`).prop('selected', true).val();
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $.each(cities, function(index, city) {
                                select.append('<option value="' + city.id + '">' + city.name["{{ $lang }}"] + '</option>');
                            });
                        }
                    });
                })
