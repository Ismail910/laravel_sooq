...
return [
    ...
    "contact" => "Contact us",
    "about" => "About",
    "transAds" => "You Can Add Announcement Many Language",
    "Currency" => "Currency",
    ...
    "Store location" => "URL Location Googal maps",
    "Rating" => "Rating",
    "Store Name" => "Store Name",
    "Cover" => "Cover",
    "AddCover" => "Add Cover",
    "Store Logo" => "Store Logo",
    "Reset Message" => "Enter Your Email to reset your password",
    ...
    "Announcement VIP" => "Distinguish your Announcement to increase its visibility and get more results by contacting us",
    "Announcement Code" => "Announcement Code",
    "Announcement Title" => "Announcement Title",
    "what'sapp" => "What'sapp",
    "Announcement Desc" => "Announcement Description",
    "Pending" => "Pending",
    "limited" => "You have exceeded the ad limit. You must upgrade the account with one of the packages",
    "price" => "Price",
    "photos" => "Photos",
    "Continue" => "Continue",
    "phone" => "Phone",
    ...
    "A fresh verification link has been sent to your email address." => "A new verification link has been sent to your registered email",
    "Before proceeding, please check your email for a verification link." => "Before proceeding, please check the activation link in your mail.",
    "If you did not receive the email" => "If you did not receive the email",
    "click here to request another" => "Click here to send another alternative link",
    ...
    "A new verification link has been sent to the email address you provided during registration." => "A new verification link has been sent to the email address you registered with.",
    ...
    "Administrator users can perform any action." => "Administrators can perform any action.",
    ...
    "An unexpected error occurred and we have notified our support team. Please try again later." => "An unexpected error occurred and technical support was reported. Please try again later.",
    "Andorra" => "Andorra",
    "Angola" => "Angola",
    "Anguilla" => "Anguilla",
    ...
    "April" => "April",
    "Are you sure you want to delete the selected resources?" => "Are you sure you want to delete these resources?",
    "Are you sure you want to delete this file?" => "Are you sure you want to delete this file?",
    "Are you sure you want to delete this resource?" => "Are you sure you want to delete this resource?",
    "Are you sure you want to delete this team? Once a team is deleted, all of its resources and data will be permanently deleted." => "Are you sure you want to delete this team? Once a team is deleted, all of its resources and data will be deleted.",
    "Are you sure you want to delete your account? Once your account is deleted, all of its resources and data will be permanently deleted. Please enter your password to confirm you would like to permanently delete your account." => "Surely your account? Once you delete your account, all data related to it will be permanently deleted. Please enter your password to confirm that you wish to permanently delete your account.",
    ...
    "Disable" => "Disable",
    "Djibouti" => "Djibouti",
    "Do you really want to leave? You have unsaved changes." => "Do you really want to leave? You haven't saved changes.",
    "Dominica" => "Dominica",
    ...
    "Editor" => "Editor",
    "Editor users have the ability to read, create, and update." => "Editors have the ability to read, create, and update.",
    "Egypt" => "Egypt",
    ...
    "Enable" => "Enable",
    "Ensure your account is using a long, random password to stay secure." => "Make sure your account uses a long, random password to stay secure.",
    ...
    "Extra confirmation is needed to process your payment. Please confirm your payment by filling out your payment details below." => "Extra confirmation is needed to complete your payment. Please confirm your payment by filling in your payment details below.",
    ...
    "Fiji" => "Fiji",
    "Finland" => "Finland",
    "For your security, please confirm your password to continue." => "For your protection, please confirm your password to continue.",
    "Forbidden" => "forbidden",
    ...
    "Forgot Your Password?" => "Forgot your password?",
    "Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one." => "Forgot your password? No problem. Just let us know. with your email address and we will send you a password reset link that will allow you to choose a new password.",
    "France" => "France",
    ...
    "Great! You have accepted the invitation to join the :team team." => "Great! I've accepted the invitation to join the :team team.",
    "Greece" => "Greece",
    "Greenland" => "Greenland",
    "Grenada" => "Grenada",
    ...
    "I agree to the :terms_of_service and :privacy_policy" => "I agree to :terms_of_service and :privacy_policy",
    "Iceland" => "Iceland",
    "ID" => "identifier",
    "If necessary, you may log out of all of your other browser sessions across all of your devices. Some of your recent sessions are listed below; however, this list may not be exhaustive. If you feel your account has been compromised, you should also update your password." => "If necessary, you can sign out of all other browser sessions across all of your devices. Some of your recent sessions are listed below; however, this list may not be exhaustive. If you feel your account has been hacked, you should Also update your password.",
    "If you already have an account, you may accept this invitation by clicking the button below:" => "If you already have an account, you can accept this invitation by pressing the button below:",
    ...
    "If you do not have an account, you may create one by clicking the button below. After creating an account, you may click the invitation acceptance button in this email to accept the team invitation:" => "If you don't have an account, You can create an account by clicking on the button below. After creating an account, you can click on the Accept Invitation button in this email to accept the team invite:",
    "If you need to add specific contact or tax information to your receipts, like your full business name, VAT identification number, or address of record, you may add it here." => "If you need to add contact or tax information specific to your receipts, such as your full business name, VAT identification number, or registry address, you can add it here.",
    "If you're having trouble clicking the \":actionText\" button, copy and paste the URL below\ninto your web browser:" => "If you are having trouble clicking the \":actionText\" button, you can copy URL below\n and paste it in your web browser:",
    "If you're having trouble clicking the \":actionText\" button, copy and paste the URL below\ninto your web browser:" => "If you are having trouble clicking the \":actionText\" button, you can copy URL below\n and paste it in your web browser:",
    "Increase" => "increase",
    "India" => "India",
    "Indonesia" => "Indonesia",
    ...
    "Isle of Man" => "Isle of Man",
    "Israel" => "Israel",
    "It looks like you do not have an active subscription. You may choose one of the subscription plans below to get started. Subscription plans may be changed or canceled at your convenience." => "Subscription plans below to get started. You can change or cancel your subscription plans at any time.",
    "Italy" => "Italy",
    "Jamaica" => "Jamaica",
    "Jane Doe" => "Jane Doe",
    "January" => "January",
    ...
    "Log in" => "Login",
    "Log Out" => "Log Out",
    "Log Out Other Browser Sessions" => "Log Out of Your Sessions on Other Browsers",
    "Login" => "Login",
    "Logout" => "Logout",
    ...
    "Nevermind, I'll keep my old plan" => "Never mind, I'll keep my old plan",
    "New" => "new",
    ...
    "Niue" => "Niue",
    "No" => "No",
    "No:resource matched the given criteria." => ":resource does not match the given criteria.",
    ...
    'DevliveryMethod' => "Devlivery Method",
    "directReceiving" => "Direct Receiving",
    "shippingCompanies" => "Shipping Companies",
    "DeliveryMen" => "Delivery Men",
    "contactBuyer" => "Chat with buyer",
    "displayshippingCompanies" => "Display Shipping Companies",
    "displayDeliveryMen" => "Display Delivery Men",
    "AddYourCompanyToFreeDirectory" => "Add your company to Free Directory",
    "EditProfile" => "Edit Profile",
    "companies" => "Companies",
    "individuals" => "Individuals",
    "AddYourStore" => "Add Your Company",
    "EditYourStore" => "Edit Your Company",
    "AddYourPage" => "Add Your Page",
    "EditYourPage" => "Edit Your Page",
    "addStorePlaceholder" => "Fill in all the information below to create your own company",
    "EditStorePlaceholder" => "Fill in all the information below to edit your own company",
    "addPagePlaceholder" => "Fill in all the information below to create your page",
    "EditPagePlaceholder" => "Fill in all the information below to edit your page",
    "Commercial Licence" => "Commercial License",
    "socialMedia" => "Add Social Media",
    "IAgreeTo" => "I Agree To",
    "Confirmandcreatestore" => "Create Company",
    "Confirmandeditstore" => "Edit Company",
    "namePlacholder" => "Enter your company name",
    "Store Desc Placeholder" => "Enter a description for your company",
    "Page Desc" => "Page Description",
    "Page Desc Placeholder" => "Add a description for your page here",
