...
return [
    ...
    "editNumber" => "تعديل رقم الهاتف",
    "remember_me" => "تذكرني",
    "forget_your_password" => "هل نسيت كلمة المرور ؟",
    "login" => "تسجيل الدخول",
    "Show All" => "عرض الكل",

    "Select City" => "تحـديد المحافظة",
    "Select Category" => "تحديد القسم",
    "Select Main Category" => "تحـديد القسم الرئيسي",
    "Select SubCategory" => "تحـديد القسم الفرعي",
    "OpenStore" => "افتح متجرك الان",
    "visitors" => "أنت الزائر رقم",
    "AddAnnouncement" => "اضف اعلانك الان",
    "FreeDirectory" => "الدليل المجاني",
    ...
    "required" => "مطلوب",
    "Language" => "اللغة",
    "register" => "إنشاء حساب والدخول",
    "name" => "الإسم",
    "about" => "من نحن",


    "Store location" => "الرابط علي خرائط جوجل",
    "Store Name" => "اسم المتجر",
    "Cover" => "صورة الغلاف",
    "AddCover" => "أضف صورة الغلاف",
    "Store Logo" => "شعار المتجر",
    "Store Button" => "تأكيد المعلومات وانشاء المتجر",
    "Store Desc" => "وصف المتجر",
    "Store msg" => "قم بتعبئة جميع المربعات بالاسفل لإنشاء متجرك الخاص",
    "Rating" => "التقيم",
    "Note Info" => "يرجى عدم مشاركةاي بيانات شخصية مثل رقم الهاتف والبربد, لعدم فقدان الضمان",
    ...
    "Announcement Publiched" => "تم نشر اعلانك",
    "Announcement VIP" => "قم بتميز اعلانك لزيادة ظهوره والحصول علي نتائج اكثر من خلال التواصل معنا",
    "Announcement Code" => "كود الاعلان",
    "Announcement Title" => "عنوان الاعلان",
    "what'sapp" => "واتساب",
    "Announcement" => "الاعلان",
    "Announcements" => "اعلانات",
    "related :resource" => ":resource مشابهة",
    "Announcement Desc" => "وصف الاعلان",
    "Pending" => "قيد المراجعة",
    "limited" => "لقد تجاوزت الحد المسموح به للإعـلانات يجب ترقية الحساب بإحدى الباقات",
    "price" => "السعر",
    "photos" => "صور",
    "Continue" => "متابعة",
    "Inquiry" => "استفسار",
    "Representative visit" => "زيارة مندوب",
    "contact" => "اتصل بنا",
    ...
    ":days day trial" => ":days يوم تجريبي",
    ...
    "Add VAT Number" => "أضف رقم ضريبة القيمة المضافة",
    "Added." => "تمت الإضافة.",
    "Address" => "العنوان",
    ...
    "An unexpected error occurred and we have notified our support team. Please try again later." => "حدث خطأ غير متوقع وتم إبلاغ الدعم الفني. الرجاء المحاولة مرة أخرى في وقت لاحق.",
    "Andorra" => "أندورا",
    "Angola" => "أنغولا",
    "Anguilla" => "أنغويلا",
    ...
    "Confirm" => "تأكيد",
    "Language" => "اللغة",
    "transAds" => "يمكنك اضافة الاعلان بأكثر من لغة",
    ...
    "Estonia" => "إستونيا",
    "Ethiopia" => "إثيوبيا",
    "ex VAT" => "ضريبة القيمة المضافة السابقة",
    ...
    "Guyana" => "غيانا",
    "Haiti" => "هايتي",
    "Have a coupon code?" => "لديك رمز الكوبون؟",
    ...
    "New" => "جديد",
    "Reset Message" => "أدخل عنوانك لإعادة تعيين كلمة المرور الخاصة بك",
    ...
    "Receipt Email Addresses" => "عناوين البريد الإلكتروني للاستلام",
    "Receipts" => "الإيصالات",
    ...
    "Search" => "بحث",
    "Select" => "اختر",
    "Select a different plan" => "اختر خطة مختلفة",
    ...
    "September" => "سبتمبر",
    "Serbia" => "صربيا",
    "Server Error" => "خطأ في الإستضافة اعد المحاولة",
    ...
    "Sorry, your session has expired." => "عذراً، يجب تسجيل الدخول اولا",
    ...
    "Thanks for your continued support. We've attached a copy of your invoice for your records. Please let us know if you have any questions or concerns." => "شكرا لدعمكم المتواصل. لقد أرفقنا نسخة من فاتورتك. يجرى إعلامنا إذا كان لديك أي أسئلة أو مخاوف.",
    "Thanks," => "شكرا،",
    ...
    "The provided coupon code is invalid." => "رمز الكوبون المستخدم غير صالح.",
    ...
    "The receipt emails must be valid email addresses." => "يجب أن تكون صيغة عناوين البريد الإلكتروني صالحة .",
    "The resource was updated!" => "تم تحديث المصدر!",
    "The selected country is invalid." => "الدولة المختارة غير صالحة.",
    ...
    "This subscription has expired and cannot be resumed. Please create a new subscription." => "انتهت صلاحية الاشتراك ولا يمكن استئنافه. يرجى إنشاء اشتراك جديد.",
    ...
    "Turks and Caicos Islands" => "جزر توركس وكايكو",
    "Tuvalu" => "توفالو",
    ...
    "United States Minor Outlying Islands" => "جزر الولايات المتحدة النائية",
    ...
    "Update Payment Information" => "تحديث معلومات الدفع",
    ...
    "Wallis and Futuna" => "جزر والس وفوتونا",
    "We are processing your subscription" => "نقوم الآن بمعالجة اشتراكك",
    "We are unable to process your payment. Please contact customer support." => "لم نتمكن من معالجة عملية الدفع الخاصة بك. يرجى الاتصال بدعم العملاء.",
    ...
    "We will send a receipt download link to the email addresses that you specify below. You may separate multiple email addresses using commas." => "سنقوم بإرسال رابط تنزيل الإيصال لعناوين البريد الإلكتروني التي تحددها أدناه. يمكنك الفصل بين عناوين البريد الإلكتروني باستخدام الفواصل.",
    ...
    "You are currently within your free trial period. Your trial will expire on :date." => "أنت الآن ضمن الفترة التجريبية المجانية. ستنتهي الفترة التجريبية الخاصة بك في :date.",
    ...
    "Your :invoiceName invoice is now available!" => "فاتورتك :invoiceName متاحة حاليا!",
    "Your card was declined. Please contact your card issuer for more information." => "تم رفض بطاقتك. يرجى التواصل مع جهة إصدار بطاقتك لمزيد من المعلومات.",
    ...
    'DevliveryMethod' => "طريقة استلام المنتج",
    "directReceiving" => "استلام مباشر",
    "shippingCompanies" => "شركات التوصيل",
    "DeliveryMen" => "سائقي التوصيل",
    "contactBuyer" => "مراسلة البائع",
    "displayshippingCompanies" => "عرض شركات التوصيل",
    "displayDeliveryMen" => "عرض سائقي التوصيل",
    "AddYourCompanyToFreeDirectory" => "أضف شركتك للدليل المجاني",
    "EditProfile" => "تعديل البيانات",
    "companies" => "الشركات",
    "individuals" => "الأفراد",
    "AddYourStore" => "أضف شركتك",
    "EditYourStore" => "تعديل شركتك",
    "AddYourPage" => "أضف صفحتك",
    "EditYourPage" => "تعديل صفحتك",
    "addStorePlaceholder" => "قم بتعبئة جميع البيانات بالأسفل لإنشاء شركتك الخاصة",
    "EditStorePlaceholder" => "قم بتعبئة جميع البيانات بالأسفل لتعديل شركتك الخاصة",
    "addPagePlaceholder" => "قم بتعبئة جميع البيانات بالأسفل لإنشاء صفحتك",
    "EditPagePlaceholder" => "قم بتعبئة جميع البيانات بالأسفل لتعديل صفحتك",
    "Commercial Licence" => "السجل التجاري",
    "socialMedia" => "إضافة وسائل التواصل الإجتماعي",
    "IAgreeTo" => "أوافق علي",
    "Confirmandcreatestore" => "إنشاء الشركة",
    "Confirmandeditstore" => "تعديل الشركة",
    "namePlacholder" => "أدخل اسم شركتك",
    "Store Desc Placeholder" => "أدخل وصف شركتك",
    "Page Desc" => "وصف الصفحة",
    "Page Desc Placeholder" => "أضف هنا وصف صفحتك",
    "CreatePage" => "إنشاء الصفحة",
    "EditPage" => "تعديل الصفحة",
    "Company Name" => "اسم الشركة",
    "Company Desc" => "وصف الشركة",
    "Company Address" => "عنوان الشركة",

    "MyWallet" => "محفظتي",
    "TransactionID" => "رقم المعاملة",
    "TransactionAmount" => "المبلغ",
    "TransactionWay" => "مصدر المعاملة",
